...
func (r *PostRepositoryGorm) GetByID(id uint) (*entity.Post, error) {
    var post entity.Post
    err := r.db.Preload("Likes").Preload("Comments").First(&post, id).Error
    return &post, err
}

func (r *PostRepositoryGorm) GetAll() ([]entity.Post, error) {
    var posts []entity.Post
    err := r.db.Preload("Likes").Preload("Comments").Find(&posts).Error
    return posts, err
}
...
func (r *PostRepositoryGorm) Delete(id uint) error {
